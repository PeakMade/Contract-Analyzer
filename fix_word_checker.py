#!/usr/bin/env python3
"""Script to fix word_grammar_checker.py by removing grammar processing"""

file_path = r"app\services\word_grammar_checker.py"
...
print(f"Successfully wrote {len(new_content)} characters to {file_path}")

# Verify it worked
with open(file_path, 'r', encoding='utf-8') as f:
    verify_content = f.read()
    
if 'Get grammar errors' in verify_content:
    print("ERROR: Grammar processing code still present!")
else:
    print("Confirmed: Grammar processing code removed")
    print(f"File now has {len(verify_content.splitlines())} lines (was 230)")
